...
//! `split_out`, `transform`, and `dedup`. Most of these are pure — they route
//! and reshape data within the engine and use no host capability. `dedup` is
//! the one exception: it filters items against durable `StateStore` state
